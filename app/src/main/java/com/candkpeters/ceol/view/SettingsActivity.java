...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    /**
     * Needed to override in order to return to calling Activity
     * @param item
     * @return
     */
    @Override
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_key_device_server)));
            bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_key_macro1name)));
