...
public class ContentDirectoryRecyclerAdapter extends RecyclerView.Adapter<ContentDirectoryRecyclerAdapter.AudioItemViewHolder> {
    ...
    public ContentDirectoryRecyclerAdapter(Context context, CeolController controller, OnAudioItemClickListener onAudioItemClickListener) {
